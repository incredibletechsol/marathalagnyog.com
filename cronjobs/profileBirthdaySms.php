...
$query="SELECT tbp.first_name,tbp.birth_date,tci.mobile_no,tci.email_Id FROM tbl_basic_profile tbp,tbl_contact_info tci where tbp.profile_id=tci.profile_id";
...
while($row=mysqli_fetch_array($rs))
	...
	$emailid=$row[3];
        ...
        if(date('m-d') == date('m-d', $time))  
          {
          sendProfileSms($name,$mobno);
          sendEmail_Profile($name,$emailid,$headers);
          }
	}


function sendEmail_Profile($name,$emailid,$headers) 
{
date_default_timezone_set('Asia/Kolkata'); 
...
if( $nowdd == 1 || $nowdd == 3  || $nowdd == 5  || $nowdd == 7  || $nowdd == 9 )  
	...
	{
	 $mess="<b>Hi ".$name.",</b><BR><BR><h3>Happy Birthday!!! Wish you a many many happy returns of the day.May God bless you with health, wealth and prosperity in your life. </h3><BR><BR>"."<br><img src='http://vivahyog.in/birth/4.jpg'><br><br>"."<b>Thanks & Regards <BR>Vivahyog Team<br>Web:www.vivahyog.in</b>";
	  }
else 
	{
...
function sendProfileSms($name,$mobno)
{
    $username="maratha";
