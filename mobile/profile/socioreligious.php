				...
				<div class="col-lg-6">
					...
					<form class="form-horizontal group-border-dashed" action="myprofileactions.php" name="socioattr" method="post">
						...
						<div class="form-group">
							...
							<div class="col-sm-6">
								<input name="gothra" type="text" maxlength="50" id="gothra" value="<?php echo $gothra; ?>" class="form-control" required="" onkeydown= "return isAlpha(event.keyCode);"/>
							</div>
						</div>
						<div class="form-group">
							<label class="col-sm-3 control-label">Rashi</label>
							<div class="col-sm-6">
								<select size="1" name="rashi" class="form-control" required="">
						...
						<div class="form-group">
							...
							<div class="col-sm-6">
							<select size="1" name="nakshtra" class="form-control" required="">
								<option value=" " selected="selected"></option>
								  <?php
									echo $rashi;
						...
						<div class="form-group">
							...
							<div class="col-sm-6">
								<select name="charan" class="form-control" required="">
									<option value=" " selected="selected"></option>
									<?php
						...
						<div class="form-group">
							...
							<div class="col-sm-6">
								<select class="form-control" required="" name="nadi">
										<option value=" " selected="selected"></option>
										<?php
						...
						<div class="form-group">
							...
							<div class="col-sm-6">
								<select class="form-control" required="" name="gan">
									<option value=" " selected="selected"></option>
									<?php
						...
						<div class="form-group">
							...
							<div class="col-sm-6">
								<select name="mangal" id="mangal" class="form-control" required="">
								<?php
						...
						<div class="form-group">
							...
							<div class="col-sm-6">
								<input name="birthPlace" type="text" maxlength="50" id="birthPlace" value="<?php echo $birthPlace; ?>" class="form-control" required=""  onkeydown= "return isAlpha(event.keyCode);" />
							</div>
						</div>
						<div class="form-group">
							...
							<div class="col-sm-6">
								 <?php
									...
									echo "<select name='birthTimeHours' id='birthTimeHours' class='select-res' required=''>";
									...
									echo "<select name='birthTimeMins' id='birthTimeMins' class='select-res' required=''>";
									...
									echo "<select name='birthTimeAMPM' id='birthTimeAMPM' class='select-res' required=''>";
						...
						<div class="form-group">
							<div class="col-sm-offset-3 col-sm-9 m-t-15">
								<input type="submit" name="updateSocioAttr" value="Update" class="btn btn-primary">
							</div>
						</div>
					</form>
				</div><!-- end col -->
				...
				<div class="col-lg-6">
					...
					<form class="form-horizontal group-border-dashed" action="myprofileactions.php" name="familydetails" method="post">
						...
						<div class="form-group">
							...
							<div class="col-sm-6">
								<input type="text" name="fatherName" class="form-control" required="" maxlength="10" value="<?php echo $fatherName; ?>" onkeypress="return isAlpha(event.keyCode)"> 
							</div>
						</div>
						...
						<div class="form-group">
							...
							<div class="col-sm-6">
								<input type="text" name="fatherOccupation" class="form-control" required="" maxlength="10" value="<?php echo $fatherOccupation; ?>" onkeypress="return isAlpha(event.keyCode)"> 
							</div>
						</div>
						...
						<div class="form-group">
							...
							<div class="col-sm-6">
								<input type="text" name="motherName" class="form-control" required="" maxlength="10" value="<?php echo $motherName; ?>" onkeypress="return isAlpha(event.keyCode)"> 
							</div>
						</div>
						...
						<div class="form-group">
							...
							<div class="col-sm-6">
								<input type="text" name="motherOccupation" class="form-control" required="" maxlength="10" value="<?php echo $motherOccupation; ?>" onkeypress="return isAlpha(event.keyCode)"> 
							</div>
						</div>
						...
						<div class="form-group">
							...
							<div class="col-sm-6">
								<select name="noofBrothers" id="noofBrothers" class="select-res" required="" onChange="checkNoOfBrotherSister();">
								<option value=" "></option>
						...
						<div class="form-group">
							...
							<div class="col-sm-6">
								<select name="noofBrothersMarried" id="noofBrothersMarried"  class="select-res" >
									<option value=" "></option>
						...
						<div class="form-group">
							...
							<div class="col-sm-6">
							<select name="noofSisters" id="noofSisters" class="select-res" required=""  onChange="checkNoOfBrotherSister();">
									<option value=" "></option>
									 <?php
						...
						<div class="form-group">
							...
							<div class="col-sm-6">
								<select name="noofSistersMarried" id="noofSistersMarried" class="select-res">
									<option value=" "></option>
									 <?php
						...
						<div class="form-group">
							...
							<div class="col-sm-6">
								<input type="text" name="mamaLastName" class="form-control" required="" value="<?php echo $mamaLastName; ?>" onkeypress="return isAlpha(event.keyCode)"> 
							</div>
						</div>
						...
						<div class="form-group">
							...
							<div class="col-sm-6">
								<textarea columns="2" rows="3" name="lastNameOfRelatives" id="lastNameOfRelatives" class="form-control" required="">
						...
						<div class="form-group m-b-0">
							<div class="col-sm-offset-3 col-sm-9 m-t-15">
								<input type="submit" name="updateFamilyDetails" value="Update" class="btn btn-primary">
							</div>
						</div>
					</form>
				</div><!-- end col -->
