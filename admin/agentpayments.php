    ...
    function savePaymentRecvd()
		...
		b=checkInput(document.paymentrecvd);
   		if (!b) 
			...
			{
			document.paymentrecvd.action="agentpayments.php?msg=savePaymentRecvd";
				...
				while($basic_profile_row = mysqli_fetch_array($basic_profile_rs)) 
					{
					  ...
					  echo "<td><a href='agentpayments.php?agentid=$agentId&profileId=$basic_profile_row[1]&msg=paymentrcvd'><span class='label-warning label label-default'>Mark Payment Received</span></td>";  
					  echo "</tr>";
					} 
					?>
				 </tbody>
...
<div id="boxes">
                ...
                <table border=0 style="padding-bottom: 20px;" cellpadding="5" border="0" cellspacing="0">
					...
					<tr>
					 ...
					 <tr> 
                        ...
                        <a href='agentpayments.php' class='btn btn-primary btn-sm'>Cancel</a>
                        </td>
                    </tr>
	...
	<div style="top:150px; left: 551.5px; display: none;" id="dialog" class="window">
	    ...
	    <div align="center" style="margin:5px 0 5px 0;">
            ...
            echo "<a href='agentpayments.php' class='btn btn-primary btn-sm'>Ok</a>";
            ?>
