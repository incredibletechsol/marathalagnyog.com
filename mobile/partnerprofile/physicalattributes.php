				...
				<div class="col-lg-6">
					...
					<form class="form-horizontal group-border-dashed" action="myprofileactions.php" name="physicalattr" method="post">
						...
						<div class="form-group">
							...
							<div class="col-sm-6">
								<select name="heightFt" id="heightFt" class="select-res" disabled>
								<?php
								...
								<select name="heightInch" id="heightInch" style="width:60px;" class="select-res" disabled>
								<?php
						...
						<div class="form-group">
							...
							<div class="col-sm-6">
								<select name="weight"  id="weight" class="select-res" disabled >
								<option value=" "></option>
								<?php
						...
						<div class="form-group">
							...
							<div class="col-sm-6">
							<select name="bloodGroup" id="bloodGroup" class="select-res" disabled>
							 <option value=" "></option>
							 	<?php
						...
						<div class="form-group">
							...
							<div class="col-sm-6">
							<select name="complexion" id="complexion" class="select1-res" disabled>
								 <option value=" "></option>
				...
				<div class="col-lg-6">
					...
					<form class="form-horizontal group-border-dashed" action="myprofileactions.php" name="profile" method="post">
						...
						<div class="form-group">
							...
							<div class="col-sm-6">
								<select name="education" id="education" class="form-control" disabled>
								<option value=" "></option> 
								 <?php
						...
						<div class="form-group">
							...
							<div class="col-sm-6">
								<input name="annualIncome" type="text" maxlength="10" id="annualIncome" value="<?php echo $annualIncome; ?>" onkeypress="return isNumberKey(event)" class="form-control" disabled/>
							</div>
						</div>
						...
						<div class="form-group">
							...
							<div class="col-sm-6">
								<input name="occupation" type="text" maxlength="50" id="occupation" value="<?php echo $occupation; ?>" onkeydown= "return isAlpha(event.keyCode);"  class="form-control" disabled/>
							</div>
						</div>
					</form>
				</div><!-- end col -->
