...
<head>
	...
	/* Education validation 		  
		 if (form.partnerEducation.value == "") {
			error_partnerEducation.innerHTML ="<img src='images/delete.gif' border='0'>&nbsp;&nbsp;Please select Partner Education ";
			setTimeout(function () {error_partnerEducation.innerHTML =""}, 10000);
			valid = false;
		  } else {
			error_partnerEducation.innerHTML ="";
			setColor(form.partnerEducation, bgGood);
		  }		*/ 	
...
updateLastUpdatedDatetime($profileId);
						echo "<script>window.location.href = 'showprofiledetails.php?msg=success';</script>";		
					}
				}
    ...
    <div class="row">
       ...
       <?php include('noscripts.php'); ?>
        ...
        <?php
				 ...
				 echo "&nbsp;<a href='dash.php?approvedid=$profileId&status=approved' class='btn btn-success'>Activate</a>";
							 else	
				echo "&nbsp;<a href='dash.php?id=$profileId&msg=deactivate' class='btn btn-danger'>Deactivate</a>";

echo "&nbsp;&nbsp;<a href='whomandwhocontacted.php?contactid=$profileId&msg=whomcontacted' class='btn btn-success'>Whom I Contacted</a>&nbsp;&nbsp;<a href='whomandwhocontacted.php?contactid=$profileId&msg=whocontacted' class='btn btn-warning'>Who Contacted Me</a>&nbsp;&nbsp;<a href='matchingprofiles.php?contactid=$profileId&msg=matchingprofiles' class='btn btn-info'>Matching Profiles</a>";
        ...
        <div class="box-inner">
            ...
            <div class="box-content">
               <DIV id="ERRORBASICPROFILE" style="color:red;"></DIV>
				<form name="basicprofile" method="post"  action="showprofiledetails.php" onSubmit="return validateBasicProfile(this)">
					...
					<table border=0 style="padding-bottom: 20px;" cellpadding="5" border="0" cellspacing="0">
						...
						<tr>
							...
							<a href="showprofiledetails.php?msg=sendpwd" class="btn btn-warning btn-sm">Send Password</a>			
							</td>
        ...
        <div class="box-inner">
            ...
            <div class="box-content">
                	<DIV id="ERRORCONTACTINFO" style="color:red;"></DIV>
								<form name="contactinfo" method="post"  action="showprofiledetails.php" onSubmit="return validateContactInfo(this)">
            ...
            <div class="box-content">
               <DIV id="ERRORBASICPROFILE" style="color:red;"></DIV>
				  <DIV id="ERRORSOCIOATTR" style="color:red;"></DIV>	
					<form name="socioattr" method="post"  action="showprofiledetails.php" onSubmit="return validateSocioAttributes(this)">
						<table style="padding-bottom: 20px;" cellpadding="5" border="0" cellspacing="0">
        ...
        <div class="box-inner">
            ...
            <div class="box-content">
				<DIV id="ERRORPHYATTR" style="color:red;"></DIV>
					<form name="physicalattr" method="post"  action="showprofiledetails.php" onSubmit="return validatePhysicalAttr(this)">
						<table style="padding-bottom: 20px;" cellpadding="5" border="0" cellspacing="0">
							<tr>
								<td>Height</td>
								<td>:</td>
...
<div class="box-inner">
	...
	<div class="box-content">
		<DIV id="ERRORPROFILE" style="color:red;"></DIV>
			<form name="profile" method="post"  action="showprofiledetails.php" onSubmit="return validateProfile(this)">
			 <table style="padding-bottom: 20px;" cellpadding="5" border="0" cellspacing="0">
					...
					<div class="row">
						<div class="box col-md-6">
							<div class="box-inner">
								...
								<form name="familydetails" method="post"  action="showprofiledetails.php" onSubmit="return validateFamilyDetails(this)">
									<table style="padding-bottom: 20px;" cellpadding="5" border="0" cellspacing="0">
										<tr>
											<td>Father Name</td>
											<td>:</td>
							...
							<div class="box col-md-6">
								<div class="box-inner">
									...
									<div class="box-content">
										...
										<form name="profile" method="post"  action="showprofiledetails.php" onSubmit="return validatePartnerPref(this)">
										<table style="padding-bottom: 20px;" cellpadding="5" border="0" cellspacing="0">
											<tr>
												<td>Looking For </td>
												<td>:</td>
				...
				<div class="row">
					<div class="box col-md-6">
						<div class="box-inner">
							...
							<div class="box-content">
								<form name="updateHoroscopePhoto" method="post" enctype="multipart/form-data" action="showprofiledetails.php" onSubmit="return CheckHoroscopePhoto(this)">
									<?php
							...
							<div class="box-content">
								...
								<table style="padding-bottom: 20px;" cellpadding="5" border="0" cellspacing="0">
									<tr>
										...
										<td valign="top">:</td>
										<td>
											<form name="updatePhotoAlbum" method="post" enctype="multipart/form-data" action="showprofiledetails.php" onSubmit="return CheckAlbumPhoto(this)">
											<table><tr>
												<?php
												...
												$log->info("File Names are::".$first.$second.$third);	
													 if($first == "") { }
													  else echo "<td><img src='../photoalbums/$profileId/$first'  border='0' data-title='1' data-group='group-1'  class='img-responsive img-thumbnail js-lightBox img-500'/><br><a href='showprofiledetails.php?delid=$firstid'><img src='images/cross.png' border='0'></a></td>";
											         if($second == "") { }
												      else echo "<td><img src='../photoalbums/$profileId/$second' border='0' data-title='2' data-group='group-1'  class='img-responsive img-thumbnail js-lightBox img-500'/><br><a href='showprofiledetails.php?delid=$secondid'><img src='images/cross.png' border='0'></a></td>";
													 if($third == "") { }	
													  else echo "<td><img src='../photoalbums/$profileId/$third' border='0' data-title='3' data-group='group-1' class='img-responsive img-thumbnail js-lightBox img-500'/><br><a href='showprofiledetails.php?delid=$thirdid'><img src='images/cross.png' border='0'></a></td>";
													}	
												else
													{
											...
											<form name="updateAlbumStatus" method="post" action="showprofiledetails.php">
...
<div class="row">
	<div class="box col-md-6">
		<div class="box-inner">
			...
			<div class="box-content">
					<form name="updateIdProof" method="post" enctype="multipart/form-data" action="showprofiledetails.php" onSubmit="return CheckIDProof(this)">
							<?php
...
<!-- ID Proof ends here -->
	...
	<div id="boxes">
		<div style="top:150px; left: 551.5px; display: none;" id="dialog" class="window">
			...
			<br>
			<?php
			echo "<a href='showprofiledetails.php?id=$profileId' class='btn btn-primary btn-sm'>Ok</a>";
			?>
			</div>
