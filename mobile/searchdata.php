                        ...
                        <div class="card-box table-responsive">
                              <table id="datatable" class="table table-striped dt-responsive nowrap">
									...
									if(isset($_POST['searchbyprofileid']))
									{
										...
										$fetch_basic_profile="select photo.imagename,basicprofile.profile_id,basicprofile.last_name,basicprofile.sub_caste,basicprofile.age,phyattr.heightFt,phyattr.heightInch,
contactinfo.district,contactinfo.city from tbl_basic_profile basicprofile,tbl_profile_photo photo,tbl_physical_attr phyattr,tbl_contact_info contactinfo where basicprofile.profile_id=photo.profile_id and basicprofile.profile_id=phyattr.profile_id  and basicprofile.profile_id=contactinfo.profile_id and basicprofile.profile_id='$profileId' and basicprofile.status='Y' ";	
				...
				contactinfo.district,contactinfo.city from tbl_basic_profile basicprofile,tbl_profile_photo photo,tbl_physical_attr phyattr,tbl_contact_info contactinfo,tbl_profile profile where basicprofile.profile_id=photo.profile_id and basicprofile.profile_id=phyattr.profile_id  and basicprofile.profile_id=contactinfo.profile_id and basicprofile.profile_id=profile.profile_id and contactinfo.district='$district' and basicprofile.gender='$gender' and profile.education='$education' and basicprofile.status='Y' ";	
									...
									if(isset($_POST['searchbycaste']))
									{
										...
										$caste          = $_POST['caste'];
										$fetch_basic_profile="select photo.imagename,basicprofile.profile_id,basicprofile.last_name,basicprofile.sub_caste,basicprofile.age,phyattr.heightFt,phyattr.heightInch,
											contactinfo.district,contactinfo.city from tbl_basic_profile basicprofile,tbl_profile_photo photo,tbl_physical_attr phyattr,tbl_contact_info contactinfo,tbl_profile profile where basicprofile.profile_id=photo.profile_id and basicprofile.profile_id=phyattr.profile_id  and basicprofile.profile_id=contactinfo.profile_id and basicprofile.profile_id=profile.profile_id and contactinfo.district='$district' and basicprofile.gender='$gender' and basicprofile.sub_caste='$caste' and basicprofile.status='Y'";	
										Search($fetch_basic_profile);
									}
									...
									if(isset($_POST['advancesearch']))
									{
										...
										$ageTo          = $_POST['ageTo'];
										$fetch_basic_profile="select photo.imagename,basicprofile.profile_id,basicprofile.last_name,basicprofile.sub_caste,basicprofile.age,phyattr.heightFt,phyattr.heightInch,
				contactinfo.district,contactinfo.city from tbl_basic_profile basicprofile,tbl_profile_photo photo,tbl_physical_attr phyattr,tbl_contact_info contactinfo,tbl_profile profile where basicprofile.profile_id=photo.profile_id and basicprofile.profile_id=phyattr.profile_id  and basicprofile.profile_id=contactinfo.profile_id and basicprofile.profile_id=profile.profile_id and contactinfo.district='$district' and basicprofile.gender='$gender' and basicprofile.status='Y' and basicprofile.sub_caste='$caste' AND( basicprofile.age BETWEEN  $ageFrom-2 AND  $ageFrom OR basicprofile.age BETWEEN  $ageFrom-1 AND   $ageFrom OR basicprofile.age BETWEEN  $ageFrom AND  $ageTo OR basicprofile.age BETWEEN   $ageFrom AND  $ageTo+1 OR basicprofile.age BETWEEN  $ageTo AND $ageTo+2)";
										Search($fetch_basic_profile);
									}
										...
										while($basic_profile_row = mysqli_fetch_array($basic_profile_rs)) 
												{
												  echo "<tr>";
												   ...
												   if($basic_profile_row [0]=="noimg.gif")
													{
													echo "<td width='133' height='100'><a href='showpartnerdetails.php?candidate=bride&id=$basic_profile_row[1]'><img src='../images/noimg.gif' border='0' width='133' height='100' class='img-500'></a></td>";
													}
												else
													{	
													echo "<td width='133' height='100'><div style='width:100px;height:133px;'><a href='showpartnerdetails.php?candidate=bride&id=$basic_profile_row[1]'><img src='../profilepics/$basic_profile_row[0]' border='0' width='133' height='100' class='img-500'></a></div></td>";
													}
												 
												 echo "<td width=10><a href='showpartnerdetails.php?candidate=bride&id=$basic_profile_row[1]'>".$basic_profile_row[1]."</a></td>";
