		...
		<div class="box col-md-12">
			<div class="box-inner">
				<div class="box-header well" data-original-title="">
					<h2><i class="glyphicon glyphicon-user"></i> All Profiles</h2>
				...
				<div class="box-content">
							   ...
							   <thead>
                                        <tr>
                                            ...
                                            <th>Name</th>
                                             ...
                                             <th>Activation</th>
                                             <th>Whom I Contacted</th>
                                             <th>Who Contacted Me</th>
									...
									<?php
										include('../conn.php');
										$fetch_basic_profile="select basicprofile.profile_id,basicprofile.first_name,basicprofile.last_name,							contactinfo.district,contactinfo.city,basicprofile.status,DATE_FORMAT(basicprofile.create_datetime,'%d-%m-%Y %T') from tbl_basic_profile basicprofile,tbl_profile_photo photo,tbl_physical_attr phyattr,tbl_contact_info contactinfo where basicprofile.profile_id=photo.profile_id and basicprofile.profile_id=phyattr.profile_id  and basicprofile.profile_id=contactinfo.profile_id  order by basicprofile.profile_id desc ";	
										
										$basic_profile_rs= mysqli_query($conn,$fetch_basic_profile) or die(mysqli_error());
					...
					echo "<td >".$basic_profile_row[1]."&nbsp;".$basic_profile_row[2]."</td>";
											  											  echo "<td>".$basic_profile_row[4].",&nbsp;".$basic_profile_row[3]."</td>";

echo "<td>".$basic_profile_row[6]."</td>";
						
											  if($basic_profile_row [5] == "N" || $basic_profile_row [5] == "A") 
{
echo "<td><a href='dash.php?id=$basic_profile_row[0]&msg=activate' class='btn btn-success'>Activate</a></td>";
			}				 else  if($basic_profile_row [5] == "E") 
{
echo "<td><a href='dash.php?id=$basic_profile_row[0]&msg=renew' class='btn btn-success'>Renew</a></td>";
			}		
else

{
				echo "<td><a href='dash.php?id=$basic_profile_row[0]&msg=deactivate' class='btn btn-danger'>Deactivate</a></td>"; }


echo "<td><a href='whomandwhocontacted.php?contactid=$basic_profile_row[0]&msg=whomcontacted' class='btn btn-success'>Whom I Contacted</a></td>";

			echo "<td><a href='whomandwhocontacted.php?contactid=$basic_profile_row[0]&msg=whocontacted' class='btn btn-warning'>Who Contacted Me</a></td>";
											  echo "</tr>";
											} 
