...
<html>
    ...
    <body>
        ...
        <div class="wrapper">
            <div class="row">
				<div class="col-sm-12" >
					 <h4 class="page-title">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;Who Contacted Me</h4>
				</div>
            </div>
            <div class="container">
               <div class="row">
									...
									while($basic_profile_row = mysqli_fetch_array($basic_profile_rs)) 
										{
										  echo "<tr>";
										   ...
										   echo "<td><a href='showpartnerdetails.php?id=$basic_profile_row[1]&senddetails=no&who=who'>".$basic_profile_row[1]."</a></td>";
