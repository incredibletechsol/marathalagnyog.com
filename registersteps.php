...
<div class="row">
	<div>
		<form class="stepform" action="completereg.php" method="post" enctype="multipart/form-data" name="stepform">
			...
			<fieldset class="sf-step">
				<legend>1. Basic Information</legend>
					...
					<div class="col-sm-4 form-group">
						...
						<input type="text" class="form-control input-res" id="bdate" name="bdate" data-validate="1" onchange="testFunction()">
					</div>
