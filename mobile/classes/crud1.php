...
class Database{
	...
	private $db_user = "bachatga_incr";  // Change as required
	private $db_pass = "bachatgat2016@incr";  // Change as required
	private $db_name = "bachatga_incrBachat_manager";	// Change as required
