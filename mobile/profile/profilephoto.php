...
<?php
	...
	echo "<h4>".$_SESSION['fullname']."<br>(".$_SESSION['profile_id'].")</h4>";	
	echo "<input name='photo' type='file' id='photo' onchange='return CheckPhotoExt();'/><br>";
	echo "<input type='submit' name='updatePhoto' value='Upload' class='btn btn-primary btn-rounded'>";
