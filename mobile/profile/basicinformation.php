				...
				<div class="col-lg-6">
					...
					<form class="form-horizontal group-border-dashed" action="myprofileactions.php" name="basicprofile" method="post">
						...
						<div class="form-group">
							...
							<div class="col-sm-6">
								<input name="firstName" type="text" maxlength="20" id="txtFirstName" value="<?php echo $firstName; ?>" onkeydown= "return isAlpha(event.keyCode);" class="form-control" required="">
							</div>
						</div>
						<div class="form-group">
							<label class="col-sm-3 control-label">Last Name</label>
							<div class="col-sm-6">
								<input name="lastName" type="text" maxlength="20" id="txtLastName" value="<?php echo $lastName; ?>" onkeydown= "return isAlpha(event.keyCode);" class="form-control" required=""/>
							</div>
						</div>
						<div class="form-group">
						...
						<div class="form-group">
							...
							<div class="col-sm-6">
								<input type="text" id="bdate" name="bdate" class="form-control" required="" style="width:235px;" value="<?php echo $birthDate; ?>">
							</div>
						</div>
						<div class="form-group">
						...
						<div class="form-group">
							...
							<div class="col-sm-6">
								<input name="password" type="password" maxlength="20" id="password" value="<?php echo $password; ?>" class="form-control" required=""/>
							</div>
						</div>	
						<div class="form-group">
							<div class="col-sm-offset-3 col-sm-9 m-t-15">
								<input type="submit" name="updateBasicProfile" value="Update" class="btn btn-primary">
							</div>
						</div>
					</form>
				</div><!-- end col -->
				...
				<div class="col-lg-6">
					...
					<form class="form-horizontal group-border-dashed" action="myprofileactions.php" name="basicprofile" method="post">
						...
						<div class="form-group">
							...
							<div class="col-sm-6">
								<input type="text" name="mobileNo" class="form-control" required="" maxlength="10" value="<?php echo $mobileNo; ?>" onkeypress="return isNumberKey(event)"> 
							</div>
						</div>
						...
						<div class="form-group">
							...
							<div class="col-sm-6">
								<input type="text" name="alternateMobileNo" class="form-control" required="" maxlength="10" value="<?php echo $alternateMobileNo; ?>" onkeypress="return isNumberKey(event)"> 
							</div>
						</div>
						...
						<div class="form-group">
							...
							<div class="col-sm-6">
								<input type="email" class="form-control" required="" value="<?php echo $emailId; ?>" name="emailId"> 
							</div>
						</div>
						...
						<div class="form-group">
							...
							<div class="col-sm-6">
								<textarea columns="2" rows="3" name="address" id="address" class="form-control" required="">
								<?php echo $address; ?>
								</textarea>
							</div>
						</div>
						...
						<div class="form-group">
							...
							<div class="col-sm-6">
								<input type="text" name="taluka" class="form-control" required="" value="<?php echo $taluka; ?>" onkeypress="return isAlpha(event.keyCode)"> 
							</div>
						</div>
						...
						<div class="form-group">
							...
							<div class="col-sm-6">
								<input type="text" name="goan" class="form-control" required="" value="<?php echo $goan; ?>" onkeypress="return isAlpha(event.keyCode)"> 
							</div>
						</div>
						...
						<div class="form-group m-b-0">
							<div class="col-sm-offset-3 col-sm-9 m-t-15">
								<input type="submit" name="updateContactInfo" value="Update" class="btn btn-primary">
							</div>
						</div>
					</form>
				</div><!-- end col -->
